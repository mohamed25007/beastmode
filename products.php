...
<?php  if (     ((@$_REQUEST['Cat']) and (@$_REQUEST['Cat'] !="")) ||  ((@$_REQUEST['manu']) and (@$_REQUEST['manu'] !=""))  ||  ((@$_REQUEST['query']) and (@$_REQUEST['query'] !=""))  ) {  
	   ...
	   } else if(@$_REQUEST['manu']) { // Displaying Manufacturer Details
	   ...
	   $CatProducts=getSearchProducts($cat);
	   $ProducQty =count($CatProducts); 
	   }
